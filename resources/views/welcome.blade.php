...
<div class="super_container">
                    ...
                    <div class="header_container d-flex flex-row align-items-center justify-content-start">
                        ...
                        <div class="search">
                            <form action="#" class="search_form">
                                ...
                                <button type="submit" class="search_button ml-auto ctrl_class"><img src="{{asset('frontend/images/search.png')}}" alt=""></button>
                            </form>
                        </div>
            ...
            <div class="menu menu_mm">
                <div class="menu_search_form_container">
                    <form action="#" id="menu_search_form">
                        ...
                        <button id="menu_search_submit" class="menu_search_submit" type="submit"><img src="{{asset('frontend/images/search_2.png')}}" alt=""></button>
                    </form>
                </div>
    ...
    <div class="home">
        ...
        <div class="home_background" style="background-image:url({{ asset('uploads/slider/'.$slider->image) }})"></div>
        <div class="home_content">
            <div class="home_content_inner">
                <div class="home_text_large">{{ $slider->title }}</div>
                <div class="home_text_small">{{ $slider->sub_title }}</div>
            </div>
        </div>
        @endforeach
    </div>
    ...
    <div class="find">
        ...
        <div class="find_background parallax-window" data-parallax="scroll" data-image-src="{{asset('frontend/images/find.jpg')}}" data-speed="0.8"></div>
        <div class="container">
            <div class="row">
                <div class="col-12">
            ...
            <div class="row">
                <div class="col">
                    <div class="section_title text-center">
                        <h2>Top destinations in our Air Ticket</h2>
                        <div>take a look at these offers</div>
                    </div>
                </div>
            </div>
            <div class="row top_content">
                @foreach($top_packages as $top_package)
                <div class="col-lg-3 col-md-6 top_col">

                    <!-- Top Destination Item -->
                    <div class="top_item">
                        <a href="#">
                            <div class="top_item_image"><img src="{{ asset('uploads/top_package/'.$top_package->image) }}" alt="https://dmtsbd.com"></div>
                            <div class="top_item_content">
                                <div class="top_item_price">From BDT  {{ $top_package->price }}</div>
                                <div class="top_item_text">{{ $top_package->city }}, {{ $top_package->country }}</div>
                            </div>
                        </a>
                    </div>
                </div>
    ...
    <div class="last">
        ...
        <div class="last_background parallax-window" data-parallax="scroll" data-image-src="{{asset('frontend/images/last.jpg')}}" data-speed="0.8"></div>

        <div class="container">
            <div class="row">
                <div class="last_logo"><img src="{{asset('frontend/images/last_logo.png')}}" alt=""></div>
                @foreach($offers as $offer)
                <div class="col-lg-6 last_col">
                    <div class="last_item">
                        <div class="last_item_content">
                            <div class="last_subtitle">{{ $offer->location }}</div>
                            <div class="last_percent">{{ $offer->percent }}%</div>
                            <div class="last_title">{{ $offer->offer_name }}</div>
                            <div class="last_text">{{ $offer->details }}</div>
    ...
    <div class="video_section d-flex flex-column align-items-center justify-content-center">
        ...
        <div class="video_background parallax-window" data-parallax="scroll" data-image-src="{{asset('frontend/images/video.jpg')}}" data-speed="0.8"></div>
                ...
                <div class="col">
                    <div class="popular_content d-flex flex-md-row flex-column flex-wrap align-items-md-center align-items-start justify-content-md-between justify-content-start">
                        ...
                        <div class="popular_item">
                            <a href="offers.html">
                                <img src="{{ asset('uploads/top_destination/'.$top_destination->image) }}" alt="image by Egzon Bytyqi">
                                <div class="popular_item_content">
                                    <div class="popular_item_price">From {{ $top_destination->price }}</div>
                                    <div class="popular_item_title">{{ $top_destination->destination_name }}</div>
                                </div>
                            </a>
                        </div>
                        @endforeach
        ...
        <div class="special_content">
            <div class="special_slider_container">
                <div class="owl-carousel owl-theme special_slider">
                    ...
                    <div class="owl-item">
                        <div class="special_item">
                            <div class="special_item_background"><img src="{{asset('frontend/images/special_1.jpg')}}" alt="https://unsplash.com/@garciasaldana_"></div>
                    ...
                    <div class="owl-item">
                        <div class="special_item d-flex flex-column align-items-center justify-content-center">
                            <div class="special_item_background"><img src="{{asset('frontend/images/special_2.jpg')}}" alt="https://unsplash.com/@varshesh"></div>
                            <div class="special_item_content text-center">
                    ...
                    <div class="owl-item">
                        <div class="special_item d-flex flex-column align-items-center justify-content-center">
                            <div class="special_item_background"><img src="{{asset('frontend/images/special_3.jpg')}}" alt="https://unsplash.com/@paulgilmore_"></div>
                            <div class="special_item_content text-center">
                    ...
                    <div class="owl-item">
                        <div class="special_item d-flex flex-column align-items-center justify-content-center">
                            <div class="special_item_background"><img src="{{asset('frontend/images/special_4.jpg')}}" alt="https://unsplash.com/@hellolightbulb"></div>
                            <div class="special_item_content text-center">
                                <div class="special_category">Visiting</div>
                    ...
                    <div class="owl-item">
                        <div class="special_item d-flex flex-column align-items-center justify-content-center">
                            <div class="special_item_background"><img src="{{asset('frontend/images/special_5.jpg')}}" alt="https://unsplash.com/@dnevozhai"></div>
                            <div class="special_item_content text-center">
                                <div class="special_category">Visiting</div>
                ...
                <div class="special_slider_nav d-flex flex-column align-items-center justify-content-center">
                    <img src="{{asset('frontend/images/special_slider.png')}}" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="newsletter">
        <!-- Image by https://unsplash.com/@garciasaldana_ -->
        <div class="newsletter_background" style="background-image:url({{asset('frontend/images/newsletter.jpg')}})"></div>
        <div class="container">
            <div class="row">
                    ...
                    <div class="footer_latest">
                        ...
                        <div class="footer_latest_content">
                            ...
                            <div class="footer_latest_item">
                                <div class="footer_latest_image"><img src="{{asset('frontend/images/latest_1.jpg')}}" alt="https://unsplash.com/@peecho"></div>
                            ...
                            <!-- Footer Latest Post -->
                            <div class="footer_latest_item">
                                <div class="footer_latest_image"><img src="{{asset('frontend/images/latest_2.jpg')}}" alt="https://unsplash.com/@sanfrancisco"></div>
                                <div class="footer_latest_item_content">
